...
public class MockDataController {
    ...
    public ResponseEntity<?> addMockAccountToUser(@RequestParam String email,
    ...
    public ResponseEntity<?> generateMockTransactions(
            ...
            return ResponseEntity.ok("Successfully generated " + count + " random transactions for account " + accountNr);
    }
}
